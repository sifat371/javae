   ...
   */
   public void add(String item) throws InterruptedException
   {
      ...
      try
      {
         ...
         queue.add(item);
         queueChangeCondition.signalAll(); // notify all others that the queue is not empty
      }
      finally
      {
         queueLock.unlock();
   ...
   */
   public String remove() throws InterruptedException
   {
      ...
      try
      {
          ...
          queueChangeCondition.signalAll(); // notify all others that the queue is not full
      }
      finally
      {
         queueLock.unlock();
